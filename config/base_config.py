...
class Config(ABC):
    def __init__(self):
        ...
        self.qbnorm_k = args.qbnorm_k
        self.qbnorm_beta = args.qbnorm_beta
        self.mode = args.mode
        self.add = args.add
        ...
        self.use_pose_vae = args.use_pose_vae
        self.use_beat_loss = args.use_beat_loss
        self.huggingface = args.huggingface
        self.arch = args.arch
        self.clip_arch = args.clip_arch
        self.embed_dim = args.embed_dim
        self.qbnorm_mode = args.qbnorm_mode
