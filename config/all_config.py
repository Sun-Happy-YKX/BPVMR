...
class AllConfig(Config):
    ...
    def parse_args(self):
        ...
        parser.add_argument('--log_step', type=int, default=20, help="Print training log every n steps")
        parser.add_argument('--evals_per_epoch', type=int, default=2, help="Number of times to evaluate per epoch")
        ...
        parser.add_argument('--embed_dim', type=int, default=256, help="Dimensionality of the model embedding")

        # training parameters
        parser.add_argument('--add', action='store_true', default=False)
        parser.add_argument('--use_avg', action='store_true', default=False)
        parser.add_argument('--use_beat', action='store_true', default=False)
        parser.add_argument('--use_pose', action='store_true', default=False)
        parser.add_argument('--use_pose_vae', action='store_true', default=False)
        parser.add_argument('--use_cls', action='store_true', default=False)
        parser.add_argument('--use_beat_loss', action='store_true', default=False)
        parser.add_argument('--mode', type=str, default='none')
        parser.add_argument('--qbnorm_k', type=int, default=1)
        parser.add_argument('--qbnorm_beta', type=int, default=50)
        parser.add_argument('--qbnorm_mode', type=str, default='mode1')
        ...
        parser.add_argument('--num_mha_heads', type=int, default=4, help='Number of parallel heads in multi-headed attention')
        parser.add_argument('--num_layers', type=int, default=6,
                            help='Number of layers in multi-headed attention')
